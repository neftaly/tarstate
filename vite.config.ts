    ...
    build: {
      ...
      lib: {
        entry: {
          ...
          watch: 'src/watch.ts',
          write: 'src/write.ts',
          'experimental/constraints': 'src/constraints.ts',
          'experimental/delta': 'src/delta.ts',
          'experimental/diff': 'src/diff.ts',
          'experimental/identity': 'src/identity.ts',
          'experimental/indexed-source': 'src/indexed-source.ts',
          'experimental/materialization': 'src/materialization.ts',
          'experimental/runtime': 'src/runtime.ts',
          'experimental/watch': 'src/watch.ts',
          'experimental/write-apply': 'src/write-apply.ts'
        },
        formats: ['es'],
        fileName: (_format, entryName) => entryName + '.js'
      },
...
const sourceAliases = [
  ...
  { find: '@tarstate/core/experimental/constraints', replacement: path.join(repoRoot, 'packages/core/src/constraints.ts') },
  { find: '@tarstate/core/experimental/delta', replacement: path.join(repoRoot, 'packages/core/src/delta.ts') },
  { find: '@tarstate/core/experimental/diff', replacement: path.join(repoRoot, 'packages/core/src/diff.ts') },
  { find: '@tarstate/core/experimental/identity', replacement: path.join(repoRoot, 'packages/core/src/identity.ts') },
  { find: '@tarstate/core/experimental/indexed-source', replacement: path.join(repoRoot, 'packages/core/src/indexed-source.ts') },
  { find: '@tarstate/core/experimental/materialization', replacement: path.join(repoRoot, 'packages/core/src/materialization.ts') },
  { find: '@tarstate/core/experimental/runtime', replacement: path.join(repoRoot, 'packages/core/src/runtime.ts') },
  { find: '@tarstate/core/experimental/watch', replacement: path.join(repoRoot, 'packages/core/src/watch.ts') },
  { find: '@tarstate/core/experimental/write-apply', replacement: path.join(repoRoot, 'packages/core/src/write-apply.ts') },
