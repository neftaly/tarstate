...
assignArchitectureGroup('source-contract', [
  'attachment/document-declaration.ts',
  'attachment/model.ts',
  'logical-edit.ts',
  'source-protocol.ts',
  'source-state.ts'
...
const publicRuntimePolicies = new Map(Object.entries({
  ...
  'attachment/retained-text-adapter/index.ts': ['foundation', 'capability', 'artifact-resolution', 'source-contract', 'schema', 'query-model', 'query-batch', 'transaction-model', 'semantic-artifact', 'transaction-runtime', 'attachment-runtime'],
