...
import { containsNamedCall, containsSubquery, directQueryChildren } from './graph.js';
import { assertPreparedPlan, isPreparedPlan } from './prepared-plan.js';
import {
  adoptJsonValue,
...
import type { QueryMaintenanceSnapshot } from '../incremental-model.js';
