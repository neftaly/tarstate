...
} from './internal-query-aggregate-maintenance.js';
import { incrementallyMaterializeJoinWith, indexJoinSegments } from './internal-query-join-maintenance.js';
import type { QueryMaintenanceOperatorEvent } from './internal-query-maintenance-diagnostics.js';
import { emptyOperatorDiagnostics } from './internal-query-maintenance-diagnostics.js';
import {
